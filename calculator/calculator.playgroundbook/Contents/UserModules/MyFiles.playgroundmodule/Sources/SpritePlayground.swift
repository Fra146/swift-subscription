/// Una sandbox in cui giocare con gli sprite delle forme in un mondo fisico.
public class SpritePlayground {
    public init() {
        // Configura la scena per la fisica.
    ...
    /// Crea una linea di misurazione da usare per conoscere il limite di altezza a cui impilare gli sprite.
    ...
    /// Crea uno sprite di forma casuale.
